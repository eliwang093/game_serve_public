...
function FLGVideo(r, E, q, w, e, v, b, g, c, I, G) {
    ...
    if (g && g.noVideoIcons) {
        ...
        a.append(A);
        var f = $("<div></div>")
    } else D = $('<div style="position:absolute; background: url(/../games/KenoNg2Min/libs/FLGUtils/resources/Account/refresh.png) no-repeat 100% 100%; background-size: contain;opacity:0.6;"></div>'),
        D.hover(function () {
            $(this).css("opacity", 1)
        }, function () {
            $(this).css("opacity", .6)
        }), a.append(D), A = $('<div style="position:absolute; background: url(/../games/KenoNg2Min/libs/FLGUtils/resources/Video/ExpandW.png) no-repeat 100% 100%; background-size: contain;opacity:0.6;"></div>'), A.hover(function () {
        $(this).css("opacity", 1)
    }, function () {
        $(this).css("opacity", .6)
    }), a.append(A), G = c.isMuted() ? "url(/../games/KenoNg2Min/libs/FLGUtils/resources/audio/mute_icon.png)" : "url(libs/FLGUtils/resources/audio/sound_icon.png)", f = $('<div style="position:absolute; background: ' +
    ...
    var l = function (K) {
        ...
        if (g && g.noVideoIcons) D = $("<div></div>"), a.append(D), A = $("<div></div>"), a.append(A), f = $("<div></div>"); else {
            ...
            D.click(m);
            a.append(D);
            var N = B ? "url(/../games/KenoNg2Min/libs/FLGUtils/resources/Video/CollapseW.png)" :
                "url(/../games/KenoNg2Min/libs/FLGUtils/resources/Video/ExpandW.png)";
            ...
            a.append(A);
            N = c.isMuted() ? "url(/../games/KenoNg2Min/libs/FLGUtils/resources/audio/mute_icon.png)" : "url(libs/FLGUtils/resources/audio/sound_icon.png)";
